...
dependencies {
    ...
    implementation("io.ktor:ktor-server-call-logging-jvm:3.6.0")
    implementation("io.ktor:ktor-server-call-id-jvm:3.6.0")
    implementation("io.ktor:ktor-server-metrics-micrometer-jvm:3.6.0")
